          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(height: 20),
                Text(
                  'Conecte-se diretamente com os melhores fornecedores de casamento, escolhidos especialmente para você, em um único lugar.',
                  style: TextStyle(
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.of(context)
                        .pushReplacementNamed('/intro-second-step');
                  },
